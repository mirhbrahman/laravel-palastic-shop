...
use App\Http\Requests\Product\CreateProductTypeRequest;
...
class ProductTypeController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('product.product_types.index')
    ...
    {
        return view('product.product_types.create');
    }
    ...
    public function store(CreateProductTypeRequest $request)
    {
        ...
        return redirect(route('product.productTypes.index'));
    }
    ...
    public function show($id)
    {
        ...
        return view('product.product_types.show')->with('productType', $productType);
    }
    ...
    public function edit($id)
    {
        ...
        return view('product.product_types.edit')->with('productType', $productType);
    }
